...
/*
 * It won't be enough to simply require the socket.io module in other modules because
 * the io object is what wraps the server object. Instead, we'll be passing the io
 * object into whatever modules are to use it.
 *
 */
indexSocketio(io); 
notesSocketio(io); 
