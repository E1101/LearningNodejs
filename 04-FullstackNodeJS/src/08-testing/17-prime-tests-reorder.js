// Any code that is run after that line (e.g. our database module)
// will be able to tell that we're running in a test environment
// and can make behavior adjustments as necessary.
