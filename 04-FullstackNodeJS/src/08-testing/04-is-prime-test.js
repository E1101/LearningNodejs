...
function finish() {
  ...
  // if any of our results don't match what's expected,
  // we change the exit code to 1 to indicate a failure.
  // ---
  // This is useful for when we want to this test to work in
  // tandem with other processes. For example, we can make
  // running git push conditional on our tests passing:
